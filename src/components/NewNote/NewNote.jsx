...
function NewNote({ note, setNote, addNote, closeNote, deleteNote }) {
  ...
  return (
    <div className={`NewNote NewNote--${note.background}`}>
      ...
      <div className="NewNote__footer">
        ...
        <Toolbar
          ...
          changeEditable={() => setNote({ ...note, editable: !note.editable })}
